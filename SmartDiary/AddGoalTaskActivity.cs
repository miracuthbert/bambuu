...
{
    [Activity(Label = "Add Goal Task", Icon = "@drawable/storelogo", Theme = "@style/MyTheme")]
    public class AddGoalTaskActivity : AppCompatActivity
    {
        private ArrayAdapter adapter;
        private JavaList<Goals> allgoals;
