...
{
    [Activity(Label = "Add Project Task", Icon = "@drawable/storelogo", Theme = "@style/MyTheme")]
    public class AddProjectTaskActivity : AppCompatActivity
    {
        private ArrayAdapter adapter;
        private JavaList<Projects> allprojects;
